   ...
   async: async (m, {
      ...
      try {
         ...
         if (style == 1) {
            ...
            client.reply(m.chat, `By using this, you have agreed to the rules and terms of using HUTAO-BOT.\nYou can see by using command *.rules*\n\nif you find a bug in this bot, please report to the owner, type *.owner*`, m)
             await Func.delay(1500)
            client.sendMessageModify(m.chat, print, null, {

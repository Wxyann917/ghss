exports.run = {
   usage: ['motivasi', 'galau', 'gombal', 'hacker', 'bijak', 'bucin', 'quotes', 'pantun', 'islami'],
   category: 'random',
   async: async (m, {
      client,
      isPrefix,
...
global.galau = [
    "Dunia memang jahat, tapi lebih jahat lagi orang yang sudah tau hidup kita susah dan berantakan, tapi malah dibikin hancur",

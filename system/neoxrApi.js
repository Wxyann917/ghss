...
module.exports = class NeoxrApi {
   ...
   check = async () => {
    ...
    gdrive = async (url) => {
      let json = await Func.fetchJson('https://api.neoxr.eu/api/gdrive?url=' + url + '&apikey=' + this.apiKey)
      return json   
   }
   ...
   sptfy = async (query) => {
    let json = await Func.fetchJson("https://api.lolhuman.xyz/api/spotifysearch?apikey=" + key +"&query=" + query)
    return json
    }
    
    terabox = async (url) => {
    let json = await Func.fetchJson("https://xzn.wtf/api/teraboxdl?url=" + url + "&apikey=Ayu")
    return json
    }
    ...
    capcut = async (url) => {
     let json = await Func.fetchJson(
      "https://api.neoxr.eu/api/capcut?url=" + url +"&apikey=" + this.apiKey)
      return json
   }
    ...
    gpt = async (query) => {
    let json = await Func.fetchJson("https://api.lolhuman.xyz/api/openai-turbo?apikey=" + key + "&text" + query)
    return json
   }
   
    simi = async (query) => {
    let json = await Func.fetchJson("https://api.lolhuman.xyz/api/simi?apikey=" + key + "&text=" + query + "&badword=true")
    return json
   }

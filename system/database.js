module.exports = (m) => {
   ...
   if (setting) {
      ...
      if (!('sk_author' in setting)) setting.sk_author = '@rwcode.js'
      ...
      if (!('owners' in setting)) setting.owners = ['19292929999']
      ...
      if (!('cover' in setting)) setting.cover = 'https://telegra.ph/file/54eb23eedddeb7447facc.jpg'
      if (!('link' in setting)) setting.link = 'https://chat.whatsapp.com/IdoJ0yIgXPK1lvcAMuq9tH'
   } else {
      global.db.setting = {
         autodownload: true,
         chatbot: true,
         ...
         msg: 'Hi +tag 🪸\nI am an automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version\n◦ *Rest API* : https://api.neoxr.my.id\n◦ *Source* : https://github.com/neoxr/neoxr-bot\n\nIf you find an error or want to upgrade premium plan contact the owner.',
         menuStyle: 4,
         cover: 'https://telegra.ph/file/54eb23eedddeb7447facc.jpg',
         link: 'https://chat.whatsapp.com/IdoJ0yIgXPK1lvcAMuq9tH'
      }
   }
}